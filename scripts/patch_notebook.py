"""Patch rl_full_pipeline.ipynb: replace Cells 17-21 with close-to-close backtest."""
import json
...
# ═══════════════════════════════════════════════════════════
# Cell 17: Backtesting functions + run all backtests
# ═══════════════════════════════════════════════════════════
c17 = """# ============================================================
...
%matplotlib inline
import os
OUT_DIR = 'models_comparison/matd3'
...
SIGNALS += [('EW Ensemble','signal_ew_ensemble'), ('MATD3 v2','signal_matd3')]
...
"""
nb['cells'][19]['source'] = c19

# ═══════════════════════════════════════════════════════════
# Cell 20: Gate weights
# ═══════════════════════════════════════════════════════════
c20 = """# ============================================================
...
fig.suptitle('MATD3 v2 Gate Weights [0, 2]', fontsize=14, fontweight='bold')
...
for i, (ax, gc, an, cl) in enumerate(zip(axes, gate_cols, agent_names, cc)):
    ...
    ax.set_ylim(-0.05, 2.05); ax.set_ylabel('Gate')
...
"""
nb['cells'][20]['source'] = c20

# ═══════════════════════════════════════════════════════════
# Cell 21: Summary markdown
# ═══════════════════════════════════════════════════════════
c21 = """## Step E: Summary (v2)

### v2 Changes
| Item | v1 | v2 |
|------|----|----|
| Gate range | [0.5, 1.5] | **[0, 2.0]** |
| Top-K | 20 | **5** |
| Gate reg | 0.01 | **0.001** |
| dd/vol lambda | 0.5/30 | **0.3/10** |
| Epochs | 15 | **30** |
| Train data | 16 bars/day | **close bar only** |
| Backtest | per-bar NAV | **close-to-close (Backtesting.ipynb)** |
| Results dir | matd3_composite_models | **models_comparison/** |

### Outputs
- `matd3_v2_models/` model checkpoints
- `models_comparison/matd3/pnl_comparison_all_models.png`
- `models_comparison/matd3/metrics_bar_chart.png`
- `models_comparison/matd3/gate_weights_matd3.png`
- `models_comparison/matd3/metrics_comparison_full.csv`
"""
...
print('Done: Cells 17-21 replaced with close-to-close backtest framework')
